...
$MySQL = MySQL::getInstance();
	$sql = 'SELECT * FROM portfolio_item_image WHERE item_id = '.$id.' ORDER BY id ASC LIMIT 1';
	$MySQL->setQuery($sql);
...
<li id="menu-item-1451-7786" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="#concepto"><strong>POR QU� TDD</strong></a></li>
<li id="menu-item-7194-7752" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="#metodologia"><strong>METODOLOG�A</strong></a></li>
...
<div class="content fullwidth">
				...
				<div class="title-block-wrap"><h2 style="color:#0071bb" class="titleborderh2">PORTFOLIO</h2><div class="titleborderOut"><div class="titleborder"></div></div><div class="titletext"><p>HAGA CLICK SOBRE UNA CATEGOR�A O SOBRE UN TRABAJO PARA VER EL DETALLE DEL MISMO</p>
		...
		<div class="showpostpostcontent">
				...
				<div id="portfolio_block">
					<div id="remove" class="portfolioremove" data-option-key="filter">
						...
						<a class="catlink" href="#filter" data-option-value=".hasta80mts2" >hasta 80 mts2 <span class="aftersortingword"> </span></a><br>
