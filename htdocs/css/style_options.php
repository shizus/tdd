...
.infotext a,.aq-posts-block-meta a, .copyright a, .blogpostcategory .post-meta a, .singledefult .meta a, .testimonial-author a:hover span.author, .current-menu-ancestor > a,
...
.aq-block-aq_twitter_block .entry-content a, .infotext span, .testimonial-texts i,.aq-block-aq_features_block a,
.recentdescription-text, .post-page-links a, .infotext h2 span, .aq-posts-block .leftholder-date a:hover, .team .role, .featured-block h5 
...
.textSlide h1.underline {border-bottom:6px solid <?php echo $pmc_data['mainColor']; ?>;}.catlinkhover, .catlink:hover {border:2px solid <?php echo $pmc_data['mainColor']; ?>;color:<?php echo $pmc_data['mainColor']; ?> !important;}
.homerecent .recentdescription:hover {border:1px solid <?php echo $pmc_data['mainColor']; ?>;}
.TopHolder {border-top:5px solid <?php echo $pmc_data['mainColor']; ?>;}
.menu .current-menu-item{border-bottom:4px solid <?php echo $pmc_data['mainColor']; ?>;}
.aq-block-aq_features_block i:after {border:15px solid <?php echo $pmc_data['mainColor']; ?>;}
.searchTop #searchsubmit:hover {background: <?php echo $pmc_data['mainColor']; ?> url(images/topSocialIcons.png) no-repeat -219px -1px;}
.infotext-before, .infotext-after, .testimonial-before, .testimonial-after {background: <?php echo $pmc_data['mainColor']; ?> url(images/quoteIcon.png);}
 .aq-block-aq_contact_block .wpcf7-submit {border-bottom:4px solid <?php echo $pmc_data['gradient_color']; ?> !important;}
 .aq-block-aq_contact_block .wpcf7-submit:hover {background: <?php echo $pmc_data['gradient_color']; ?> !important;border-bottom: 3px solid <?php echo $pmc_data['mainColor']; ?> !important;}
/* ***********************
--------------------------------------
------------BOX COLOR----------
--------------------------------------
...
.aq-posts-block .lineseparator, .testimonials .bx-prev, .testimonials .bx-next
...
.aq-posts-block .imgholder.home-post .overdefult {background: <?php echo HexToRGB($pmc_data['mainColor'], 0.8); ?> url(images/plusIcon.png) no-repeat 160px 65px;}

#portitems4 .item4 .overdefult {background: <?php echo HexToRGB($pmc_data['mainColor'], 0.8); ?> url(images/plusIcon.png) no-repeat 110px 80px;}
...
#commentform #respond #commentform input#submit:hover, #respond #commentform input#submit:hover, .aq-block-aq_contact_block .wpcf7-submit,
 .tp-bullets.simplebullets.round .bullet.selected, .tp-bullets.simplebullets.round .bullet:hover, .infotext h2
{background:<?php echo $pmc_data['mainColor']; ?> ;}
.infotext h2 {box-shadow: 0px 0px 0px 5px <?php echo $pmc_data['mainColor']; ?> ;}
...
.iosSlider .prevButton, .blogsingleimage .prevbutton.port    {background: <?php echo $pmc_data['mainColor']; ?>; background: <?php echo HexToRGB($pmc_data['mainColor'], $pmc_data['slider_opacity']); ?>}
.iosSlider .nextButton, .blogsingleimage .nextbutton.port   {background: <?php echo $pmc_data['mainColor']; ?>; background: <?php echo HexToRGB($pmc_data['mainColor'], $pmc_data['slider_opacity']); ?> }
...
--------------------------------------
*********************** */
#headerwrap {height:<?php echo $pmc_data['header_height']?>px !important;}
#logo {margin-top:<?php echo $pmc_data['logo_top_margin']?>px;}
#header ul.menu > li > a {padding-top:<?php echo $pmc_data['menu_top_margin']?>px;}
...
.menu > li a {	font-family: <?php echo str_replace("%20"," ",str_replace(":300"," ",str_replace(":200"," ",str_replace(":400"," ",$pmc_data['menu_font'])))); ?>, "Helvetica Neue", Arial, Helvetica, Verdana, sans-serif !important; letter-spacing: normal;}
...
.menu a.important_color{border-bottom:4px solid <?php echo $pmc_data['mainColor']; ?>;}
#footer .menu a.important_color {border-bottom:none;}
.pagenav.fixedmenu a.important_color {color:<?php echo $pmc_data['mainColor']; ?> !important;border-bottom:none;}
