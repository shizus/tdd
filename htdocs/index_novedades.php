...
$sql = 'SELECT n.*, nc.categoria from novedades n INNER JOIN novedades_categorias nc ON n.categoria_id = nc.id ORDER BY fecha DESC';
$MySQL->setQuery($sql);
$novedades = $MySQL->loadObjectList();
...
<li id="menu-item-968-7790" class="menu-item menu-item-type-custom menu-item-object-custom"><a href="#contact"><strong>CONTACTO</strong></a></li>
</ul>					</div>
					<div class="respMenu">
...
<div class="main clearfix">
			<div class="content fullwidth"></div>
				<div id="aq-block-7564-61" class="aq-block aq-block-aq_clear_block aq_span12 aq-first cf"><div class="cf" style="height:20px; background:#fff"></div></div>
				<div id="aq-block-7564-62" class="aq-block aq-block-aq_title_border_block aq_span12 aq-first cf">
					<div class="border-block" id="news">
						<div class="title-block-wrap"><h2 style="color:#0080c8" class="titleborderh2 animated fadeInDown">NOVEDADES</h2>
							<div class="titleborderOut"><div class="titleborder"></div></div>
							<div class="titletext"><p><span>- PROYECTOS QUE ESTAMOS TRABAJANDO -</span>HAGA CLICK SOBRE UN PROYECTO PARA VER EL DETALLE DEL MISMO</p>
	 </div>
						</div>
						<div id="aq-block-7564-63" class="aq-block aq-block-aq_posts_full_width_block aq_span12 aq-first cf">
						<script type="text/javascript">
							jQuery(document).ready(function(){	  
							// Slider/*
						...
						<div class="aq-posts-block"><div class="post-full-width"><div class="post-full-width-inner">	<div id="showpost-post">
							<div class="showpostload" style="display: none;"><div class="loading"></div></div>
							<div class="closehomeshow-post closeajax" style="display: none;"><i class="icon-remove"></i></div>
							<div class="showpostpostcontent" style="display: none;"></div>
						</div>
						
								<ul class="sliderPostBlock">
									<li class="post-4170 post type-post status-publish format-standard hentry category-materiales category-stand tag-desk tag-laptop cf">
									
									<div class="one_third">
										<div class="imgholder home-post">
											<div class="overdefult" style="display: block;"></div>
											<div class="recentimage" style="background: none;">
												<div class="image" style="background: none;">
													<div class=""></div>
													<a href="#">
														<img src="uploads/2013/03/post-mundus-3-380x190.jpg" alt="Working on a Laptop" style="display: inline;">
													</a>
												</div>
											</div>
										</div>
										<div class="leftholder-date"> <a><div class="day">23/03/2013</div> </a></div>
										<div class="recentdescription home-post">
											<h3 class="the-title"><a href="#">Working on a Laptop</a></h3>
											<div class="lineseparator"></div>
											<div class="the_excerpt">Lorem ipsum dolor sit amet, consecteter ad&nbsp;elit sed diam nonummy nibh euismod tincidunt ut laoreet dolore mag ...</div>
											<div class="recentdescription-text"><a href="#">Read more</a></div>
										</div>
									</div>
									...
									<div align="center"><a class="allProjects" href="novedades.php">VER  TODOS LOS PROYECTOS</a></div>
									
									</div></div></div>
									
									
									</div><div id="aq-block-7564-64" class="aq-block aq-block-aq_clear_block aq_span12 aq-first cf"><div class="cf" style="height:80px; background:#fff"></div></div><div id="aq-block-7564-65" class="aq-block aq-block-aq_end_content_block aq_span12 aq-first cf">		</div>
				</div>
			</div>
		</div>
					...
					<div id="aq-block-8219-65" class="aq-block aq-block-aq_title_border_block_end aq_span12 aq-first cf"></div></div></div><div id="aq-block-8219-66" class="aq-block aq-block-aq_start_content_block aq_span12 aq-first cf"><div class="mainwrap" style="background:#f7f7f7 url(uploads/2014/06/contacto.jpg);background-size: cover;border-top:1px solid #ededed;padding:0px 0 0px 0;">
<div class="main clearfix">
<div class="content fullwidth">
