<?php
/* Aqua Tabs Block */
if(!class_exists('AQ_Faqs_Block')) {
	class AQ_Faqs_Block extends AQ_Block {
		...
		function __construct() {
			...
			//create the widget
			parent::__construct('AQ_Faqs_Block', $block_options);
		...
		function block($instance) {
			...
			$output = '';
				...
				$output .= '<div id="aq_block_faq_wrapper_'.rand(1,100).'" class="aq_block_faq_wrapper">';
