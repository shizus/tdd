...
function pagenavi_init() {
	...
	$pagenavi_options = array(
		'pages_text' => __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','wp-mundus'),
		'current_text' => '%PAGE_NUMBER%',
		'page_text' => '%PAGE_NUMBER%',
		'first_text' => __('&laquo; First','wp-mundus'),
		'last_text' => __('Last &raquo;','wp-mundus'),
		'next_text' => __('&raquo;','wp-mundus'),
		'prev_text' => __('&laquo;','wp-mundus'),
		'dotright_text' => __('...','wp-mundus'),
		'dotleft_text' => __('...','wp-mundus'),
		'style' => 1,
		'num_pages' => 5,
		'always_show' => 0,
