...
function optionsframework_admin_init() {
		...
		global $of_options_mundus_pmc, $pmc_options_machine;




		$pmc_options_machine = new Options_Machine($of_options_mundus_pmc);
...
<div class="wrap" id="of_container">
  ...
  <form id="of_form" method="post" action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" enctype="multipart/form-data" >
    <div id="header">
      <div class="logo">
        <h2>Mundus - Premium Wordpress Theme</h2> 
      </div>
	...
	foreach ($options as $value) {
		...
		case 'font':
				...
				$faces = array('arial'=>'Arial',
								...
								'Alegreya' => 'Alegreya',
								'Questrial' => 'Questrial',
								'Armata' => 'Armata',								'Quicksand' => 'Quicksand',
								'PT%20Sans' => 'PT Sans',
