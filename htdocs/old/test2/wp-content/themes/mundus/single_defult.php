...
<div class = "outerpagewrap">
	<div class="pagewrap">
		<div class="pagecontent">
			<div class = "portnavigation">								<span class="portall"><a href="<?php echo site_url(); ?>/category/proyectos/"><div class="portprev"><i class="icon-angle-left"></i></div>VOLVER A TODOS LOS PROYECTOS</a></span>
					<span><?php previous_post_link('%link', '<div class="portprev"><i class="icon-angle-right"></i><div class="link-title-previous">%title</div></div>' ,false,''); ?> </span>				
					<span><?php next_post_link('%link','<div class="portnext"><i class="icon-angle-left"></i><div class="link-title-next">%title</div></div>',false,''); ?> </span>
			</div>
		</div>
