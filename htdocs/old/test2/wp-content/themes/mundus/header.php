...
<head>
	...
	?>
	<?php wp_head();?>
	<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/css/font/MyFontsWebfontsKit.js"></script>
	<!-- <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/css/font/MyFontsWebfontsKit.css"/>-->
</head>		
<!-- start body -->
<body <?php body_class(); ?>>
	<!-- start header -->
						...
						if(is_front_page()){
							if ( has_nav_menu( 'resp_menu' ) ) {
								$menuParameters =  array(
								  ...
								  'echo'            => false,
								  'items_wrap'     => '<form name="menu_selector" method="post" action="#"><select name="url_list" class="event-type-selector-dropdown" onchange="gotosite(this)"><option value="" selected="selected" disabled="disabled">Seleccione...</option>%3$s</select></form>',
								);
