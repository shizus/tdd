...
class WP_Locale {
	 ...
	 * as Domingo and Sábado, don't conflict. See init() method for more.
	 *
	 ...
	 * and ends on Sábado with is fetched by using 6 (six).
	 *
	 * @since 2.1.0
	 * @access public
	 *
	 * @param int $weekday_number 0 for Domingo through 6 Sábado
