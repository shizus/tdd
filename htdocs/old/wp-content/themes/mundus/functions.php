...
function pmc_portfolio_options(){
    ...
    <div id="portfolio-options">
        <table cellpadding="15" cellspacing="15">
            ...
            <tr>
            	<td><label>EXPO: <i style="color: #999999;"></i></label></td><td><input name="website_url" style="width:80%" value="<?php echo $website_url; ?>" /></td>
            </tr>
            <tr>
            	<td><label>LUGAR: <i style="color: #999999;"></i></label></td><td><input name="author" style="width:80%" value="<?php echo $author; ?>" /></td>
            </tr>			
            <tr>
            	<td><label>PROYECTO: <i style="color: #999999;"></i></label></td><td><input name="status" style="width:80%" value="<?php echo $status; ?>" /></td>
            </tr>	
            <tr>
            	<td><label>Fecha: <i style="color: #999999;">(Fecha del proyecto)</i></label></td><td><input name="date" style="width:80%" value="<?php echo $date; ?>" /></td>
            </tr>	
            <tr>
            	<td><label>Cliente: <i style="color: #999999;">(Cliente del proyecto)</i></label></td><td><input name="customer" style="width:80%" value="<?php echo $customer; ?>" /></td>
            </tr>	
            <tr>
            	<td><label>Required skils: <i style="color: #999999;">(each skill into new line)</i></label></td><td><textarea name="skils" style="width:80%; height:300px;" /><?php echo $skils; ?></textarea></td>
            </tr>				
        </table>
    </div>
