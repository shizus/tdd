					...
					echo '	<div id = "showpost-post">
						...
						if(!has_post_format( 'link' , get_the_id())){
							...
							echo '<li class="'.implode(' ', get_post_class()).' cf">';
								...
								echo ' <a>';
								echo '<div class="day">'. get_the_time('j')  .'/'. get_the_time('m') .'/'. get_the_time('Y').'</div> </a>';
								echo '</div>';			
						...
						echo '</ul>';												echo '<div align="center"><a class="allProjects" href="'.site_url().'/category/proyectos/">VER  TODOS LOS PROYECTOS</a></div>';					
					echo '</div>';
				echo '</div>';	
			echo '</div>';
		}
